...
public class FinancesConstants {
  ...
  public static final String FOOD_EXPENSES = "food";
  public static final String TRANSPORT_EXPENSES = "transport";
  public static final String UTILITIES_EXPENSES = "utilities";
  public static final String HEALTHCARE_EXPENSES = "healthcare";
